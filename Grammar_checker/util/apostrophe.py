...
#print(apostropheError([pos_tag(word_tokenize("It will be so nice to go to the beach. I want to confirm on which day we are leaving! Are we planning to get there now? I can't wait to spend some time with you. Thanks!"))]))
