...
def spell_checker(data):
    ...
    for word in misspelled:
        ...
        if  word != corr_word and not word.isupper() and word not in ['.','"',"'",'?','!',':',';','(',')','[',']','{','}',',']:   #if condition for checking if token is not in uppercase or any for the following punctuation marks.
